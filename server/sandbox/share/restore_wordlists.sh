...
head -n 5000 "$BASE_DIR/wordlists/dns/subdomains_large.txt" > temp && mv temp "$BASE_DIR/wordlists/dns/subdomains_large.txt"
...
head -n 1500 "$BASE_DIR/wordlists/dns/subdomains_medium.txt" > temp && mv temp "$BASE_DIR/wordlists/dns/subdomains_medium.txt"
...
head -n 500 "$BASE_DIR/wordlists/dns/subdomains_short.txt" > temp && mv temp "$BASE_DIR/wordlists/dns/subdomains_short.txt"
...
head -n 5000 "$BASE_DIR/wordlists/web/files.txt" > "$BASE_DIR/wordlists/web/files_large.txt"
head -n 1500 "$BASE_DIR/wordlists/web/files.txt" > "$BASE_DIR/wordlists/web/files_medium.txt"
head -n 500 "$BASE_DIR/wordlists/web/files.txt" > "$BASE_DIR/wordlists/web/files_short.txt"
...
head -n 5000 "$BASE_DIR/wordlists/web/folders.txt" > "$BASE_DIR/wordlists/web/folders_large.txt"
head -n 1500 "$BASE_DIR/wordlists/web/folders.txt" > "$BASE_DIR/wordlists/web/folders_medium.txt"
head -n 500 "$BASE_DIR/wordlists/web/folders.txt" > "$BASE_DIR/wordlists/web/folders_short.txt"
...
head -n 5000 "$BASE_DIR/seclists/Passwords/Common-Credentials/pass.txt" > "$BASE_DIR/seclists/Passwords/Common-Credentials/passwords_large.txt"
head -n 1500 "$BASE_DIR/seclists/Passwords/Common-Credentials/pass.txt" > "$BASE_DIR/seclists/Passwords/Common-Credentials/passwords_medium.txt"
head -n 500 "$BASE_DIR/seclists/Passwords/Common-Credentials/pass.txt" > "$BASE_DIR/seclists/Passwords/Common-Credentials/passwords_short.txt"
...
head -n 5000 "$BASE_DIR/seclists/Usernames/names.txt" > "$BASE_DIR/seclists/Usernames/usernames_large.txt"
head -n 1500 "$BASE_DIR/seclists/Usernames/names.txt" > "$BASE_DIR/seclists/Usernames/usernames_medium.txt"
head -n 500 "$BASE_DIR/seclists/Usernames/names.txt" > "$BASE_DIR/seclists/Usernames/usernames_short.txt"
...
head -n 1500 "$BASE_DIR/seclists/Discovery/Web-Content/common.txt" > "$BASE_DIR/seclists/Discovery/Web-Content/common_medium.txt"
