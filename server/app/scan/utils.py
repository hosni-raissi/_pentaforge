...
def _build_planner_kickoff_message(
    *,
    ...
    return (
        ...
        "## Planner Task\n"
        "1. FIRST STEP: create the initial executable pentest plan with EXACTLY 5 scenarios total.\n"
        "2. The synthesized checklist is guidance only. Do not render checklist items as plan rows, and do not expand the full checklist into phases.\n"
        ...
        "5. Pick the five strongest next scenarios across reconnaissance, enumeration, and exploitation; later planner loops will add more.\n"
        "6. Do not leave Reconnaissance empty. Include exploitation only when P1-P2 checklist items or warmup evidence justify active testing.\n"
        "7. The persisted plan must contain exactly 5 scenario objects, not 15 checklist-style items.\n"
        "8. Prefer one scenario per major testing domain when evidence supports it, but never add a reporting/documentation scenario.\n"
