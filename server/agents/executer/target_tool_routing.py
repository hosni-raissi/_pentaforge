...
EXPLOIT_TOOL_TARGET_TYPES: dict[str, set[str]] = {
    ...
    "credential_brute": {"network", "infra", "linux_server", "database", "iot"},
    "db_injection_test": {"database", "api", "web_app"},
...
_TARGET_TYPE_PATTERNS: list[tuple[str, re.Pattern[str]]] = [
    ...
    ("database", re.compile(r"\b(mysql|postgres|mssql|mongodb|redis|database)\b", re.IGNORECASE)),
