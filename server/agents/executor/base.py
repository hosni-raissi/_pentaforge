...
from server.agents.executor.sandbox import ensure_sandbox_environment
...
from server.agents.executor.target_tool_routing import extract_discovered_target_types
...
class BaseExecuterAgent:
    ...
    async def _run_tools(
        ...
        for tc in tool_calls:
            ...
            from server.agents.executor.global_cache import GlobalToolCache
