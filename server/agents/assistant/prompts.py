...
- If the user asks what tools, commands, or access you have, be helpful. Explain that you can run network diagnostics (nmap, curl, etc.), search project evidence, and inspect target pages.
